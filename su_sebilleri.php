...
<div class="container product-list-page">
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Su Sebilleri (<?php echo $urun_sayisi; ?> Ürün)</li>
      </ol>
    </nav>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted">Bu kategoride henüz su sebili bulunmuyor.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
