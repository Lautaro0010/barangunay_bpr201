...
<div class="container product-list-page">
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Bulaşık Makineleri (<?php echo $urun_sayisi; ?> Ürün)</li>
      </ol>
    </nav>
                ...
                <div class="col">
                    <div class="card product-card h-100 p-2">
                        <a href="index.php?sayfa=urun_detay&id=<?php echo $u['id']; ?>">
                            <img src="img/<?php echo !empty($u['resim_yolu']) ? $u['resim_yolu'] : 'bulasik-default.jpg'; ?>" 
                                 class="card-img-top" 
