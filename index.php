...
switch ($page) {
    ...
    case 'profilim':
        $pageTitle = 'Profil Bilgilerim | Günay';
        $contentFile = 'profilim.php';
        break;
    case 'siparislerim':
    $pageTitle = 'Siparişlerim | Günay';
    $contentFile = 'siparislerim.php';
    break;
    case 'siparis_detay':
    $pageTitle = 'Sipariş Detayı | Günay';
    $contentFile = 'siparis_detay.php';
    break;

    default:
        http_response_code(404);
        $pageTitle = 'Sayfa Bulunamadı (404) | Günay';
        $contentFile = '404.php';   
        break;
}
...
<div class="header-wrapper <?php echo $isLoginPage ? 'fixed-nav-override' : 'sticky-top'; ?>">
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <?php endif; ?>
                <a href="index.php?sayfa=servis_cagir" class="btn btn-outline-secondary border-0 me-2 d-none d-sm-inline-block">
                    <i class="fa-solid fa-screwdriver-wrench me-1"></i> Servis
                </a>
                <a href="index.php?sayfa=sepet" class="btn btn-light border me-2">
                    <i class="fa-solid fa-cart-shopping text-dark"></i> <span class="badge bg-dark text-white ms-1"><?php echo $cart_count; ?></span>
                </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light header-nav border-bottom"> 
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-dark active-custom" aria-current="page" href="index.php#gototanıtım"><i class="fa-solid fa-list me-2"></i>Ürünlerimiz</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="index.php?sayfa=kampanyalar">Kampanyalar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="index.php?sayfa=iletisim">İletişim</a>
                    </li>
                </ul>
...
<section class="ürün_tanıtımı my-5 position-relative" id="gototanıtım" style="background:#f2f4f7; padding:30px 0;">
    <div id="urunCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-indicators">
            <button type="button" data-bs-target="#urunCarousel" data-bs-slide-to="0" class="active"></button>
            <button type="button" data-bs-target="#urunCarousel" data-bs-slide-to="1"></button>
            <button type="button" data-bs-target="#urunCarousel" data-bs-slide-to="2"></button>
        </div>
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="container">
                    <div class="row g-3">
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Buzdolabı linkleri">
                                    <a href="index.php?sayfa=buzdolaplari" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Buzdolabı</a><br><br>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Çamaşır linkleri">
                                    <a href="index.php?sayfa=camasir" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Çamaşır Makinesi</a><br><br>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Bulaşık linkleri">
                                    <a href="index.php?sayfa=bulasik" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Bulaşık Makinesi</a><br><br>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row g-3">
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                <br><br><br>
                                <img src="img/fırın.webp" alt="" style="width:300px;height:auto;margin-bottom:1rem;">
                                <nav class="link-items" role="navigation" aria-label="Fırın linkleri">
                                    <a href="index.php?sayfa=firin" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Ankastre Fırın</a><br>
                                </nav><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                <br>
                                <img src="img/ankastre.webp" alt="" style="width:150px;height:auto;margin-bottom:1rem;">
                                <nav class="link-items" role="navigation" aria-label="Ankastre linkleri">
                                    <a href="index.php?sayfa=ankastre" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Ankastre Davlumbaz</a><br><br>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                <br>
                                <img src="img/ocak.webp" alt="" style="width:180px;height:auto;margin-bottom:1rem;">
                                <nav class="link-items" role="navigation" aria-label="Ocak linkleri">
                                    <a href="index.php?sayfa=ocak" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Ankastre Ocak</a><br><br>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Süpürge linkleri"><br><br><br>
                                    <a href="index.php?sayfa=supurge" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Süpürge</a><br><br><br><br>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center;">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Su Sebili linkleri">
                                    <a href="index.php?sayfa=su_sebilleri" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Su Sebili</a><br><br>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 urun-kart">
                            <div class="buzdolabı p-4 link-list" style="background:#ffffff;border-radius:8px;min-height:260px;display:grid;justify-items:center">
                                ...
                                <nav class="link-items" role="navigation" aria-label="Mutfak linkleri">
                                    <a href="index.php?sayfa=kucuk_evaletleri" class="btn btn-outline-dark w-100 mb-2 text-start title-btn">Mutfak Robotu</a>
                                </nav>
                            </div>
                        </div>
                    </div>
...
<section class="newsletter bg-light py-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <form id="newsletterForm" class="d-flex" action="index.php" method="GET">
                    <input id="newsletterEmail" type="email" name="email" class="form-control me-2" placeholder="E-posta adresiniz" required>
        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-3">
                ...
                <ul class="footer-products list-unstyled small">
                    <li><a href="index.php?sayfa=buzdolaplari" class="footer-link">Buzdolabı</a></li>
                    <li><a href="index.php?sayfa=camasir" class="footer-link">Çamaşır</a></li>
                    <li><a href="index.php?sayfa=bulasik" class="footer-link">Bulaşık</a></li>
                    <li><a href="index.php?sayfa=firin" class="footer-link">Fırın</a></li>
                    <li><a href="index.php?sayfa=ankastre" class="footer-link">Ankastre</a></li>
                    <li><a href="index.php?sayfa=supurge" class="footer-link">Süpürge</a></li>
                    <li><a href="index.php?sayfa=ocak" class="footer-link">Ocak</a></li>
                    <li><a href="index.php?sayfa=su_sebilleri" class="footer-link">Su Sebilleri</a></li>
                    <li><a href="index.php?sayfa=kucuk_evaletleri" class="footer-link">Küçük Ev Aletleri</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 mb-3">
                <h6>Yardım</h6><br>
                <ul class="footer-products list-unstyled small">
                    <li><a href="index.php?sayfa=sss" class="footer-link">Sıkça Sorulan Sorular</a></li>
                    <li><a href="index.php?sayfa=garanti" class="footer-link">Garanti ve Servis</a></li>
                </ul>
            </div>
