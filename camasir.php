...
<div class="container product-list-page">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Çamaşır Makineleri (<?php echo $urun_sayisi; ?> Ürün)</li>
      </ol>
    </nav>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card product-card h-100 p-2">
                        <a href="index.php?sayfa=urun_detay&id=<?php echo $u['id']; ?>">
                            <img src="img/<?php echo !empty($u['resim_yolu']) ? $u['resim_yolu'] : 'camasir-default.jpg'; ?>" 
                                 class="card-img-top" 
                        ...
                        <div class="card-body text-center d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <p class="card-text text-muted small mb-3">
                                    <?php echo htmlspecialchars($u['model_kodu'] ?? 'Standart Çamaşır Makinesi'); ?>
                                </p>
                            </div>
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    <i class="fa-solid fa-soap fa-3x text-muted mb-3"></i>
