...
<div class="container product-list-page">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Fırınlar (<?php echo $urun_sayisi; ?> Ürün)</li>
      </ol>
    </nav>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card product-card h-100 p-2">
                        <a href="index.php?sayfa=urun_detay&id=<?php echo $u['id']; ?>">
                            <img src="img/<?php echo !empty($u['resim_yolu']) ? $u['resim_yolu'] : 'no-firin.jpg'; ?>" 
                                 class="card-img-top" 
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    ...
                    <p class="text-muted">Bu kategoride fırın modeli bulunamadı.</p>
                </div>
            <?php endif; ?>
